...
<!-- Side Navigation -->
	<div class="sidenav">
		...
		<a href="${pageContext.request.contextPath}/custom-login?logout">Logout</a>
	</div>

<!-- Main Content -->
<div class="main" align=center>
	<h2 id="successMsg">KYC Approved!</h2>
	<hr/>
	<h4 id="detailsLabel">KYC and UCI Details:</h4>
	<h3>KYC ID: ${kycUciDetails.kycId}</h3>
	<h3>UCI ID: ${kycUciDetails.uci}</h3>
	<h3>System Password: ${kycUciDetails.sysPassword}</h3>
</div>
<hr/>
