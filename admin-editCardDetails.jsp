...
<div class="main" align=center>
	<h2 id="successMsg">Update Card Status!</h2>
	<hr/>
	<spring:form action="${pageContext.request.contextPath}/admin/carddetailsSave" method="post" modelAttribute="applyCardInputDto">
		<div>
			<div><spring:label path="id">id</spring:label></div>
			<div>
				<spring:input type="text" path="id" name="id" value="${applyCardInputDto.id}" readonly="true"/>
			</div>
		<br/>
		
		<div>
			<div><spring:label path="cardCategory">cardCategory</spring:label></div>
			<div>
				<spring:input type="text" path="cardCategory" name="cardCategory" value="${applyCardInputDto.cardCategory}" readonly="true"/>
			</div>
		<br/>
		<div>
			<div><spring:label path="cardType">cardType</spring:label></div>
			<div>
				<spring:input type="text" path="cardType" name="cardType" value="${applyCardInputDto.cardType}" readonly="true"/>
			</div>
		</div>
		<br/>
