...
<!-- Main Content -->
<div class="main">
	<h2>Fetch Service Provider Details</h2>
	<hr>
	<spring:form action="${pageContext.request.contextPath}/admin/getsp-details" method="post" modelAttribute="getSpDetails">
		<div>
			<div>
				<div><spring:label path="spId">SP ID</spring:label></div>
				<div>
					<spring:input type="text" path="spId" name="SP ID"/>
					<div><spring:errors path="spId" cssClass="error"/></div>
				</div>
			</div>
			<br/>
